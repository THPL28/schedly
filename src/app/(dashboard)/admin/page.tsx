...
import AdminActions from '@/app/(dashboard)/admin/admin-actions'
import { Users, CalendarCheck, ShieldCheck, Mail, Zap, ArrowRight, Clock, Star, Sparkles, TrendingUp } from 'lucide-react'
        ...
        <div className="p-6 sm:p-12 max-w-[1500px] mx-auto animate-in fade-in duration-1000">
                ...
                <div className="relative z-10 flex flex-col xl:flex-row items-center justify-between gap-12">
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full xl:w-auto">
                        <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-[2rem] text-center flex flex-col items-center gap-4 hover:bg-white/10 transition-all duration-500 group">
                            ...
                            <div>
                                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest leading-none mb-2">Total de usuários</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                {[
                    ...
                    { label: 'Crescimento no mês', value: '+12.4%', icon: TrendingUp, color: 'text-primary', bg: 'bg-primary/10' },
                    { label: 'Status do sistema', value: 'Online', icon: Sparkles, color: 'text-primary', bg: 'bg-primary/10' },
                ].map((stat, i) => (
                                    ...
                                    <td className="py-8 px-10">
                                        <div className="flex items-center gap-5">
                                            <div className="w-14 h-14 rounded-2xl bg-white shadow-xl shadow-slate-200 border border-slate-100 flex items-center justify-center text-xl font-black text-primary overflow-hidden shrink-0 group-hover:scale-105 transition-transform">
                                                {u.avatarUrl ? <img src={u.avatarUrl} alt={u.name || "Avatar"} className="w-full h-full object-cover" /> : u.name?.[0]}
                                            </div>
